const Footer = () => {
  return (
    <div>
      <footer className="footer grid-cols-2 md:grid-cols-3 p-10 bg-slate-800 text-white">
  <nav>
...
<footer className="footer   px-10 py-4  bg-slate-900 text-white border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>MediCamp <br/>The Best Healthcare Management</p>
  </aside> 
